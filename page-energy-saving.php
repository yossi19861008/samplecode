  ...
  <article id="main">
    ...
    <div id="wrapper">
        ...
        <section id="mv" class="under_mv">
          <div class="inner">
            ...
            <div class="mv_txt_area">
              <p class="mv_tit Radley">ENERGY SAVING</p>
              <p class="mv_txt">省エネ対策</p>
            </div>
            <div class="breadcrumbs pc">
              <ol itemscope itemtype="http://schema.org/BreadcrumbList" class="list_area">
                ...
                <li itemscope itemprop="itemListElement" itemtype="http://schema.org/ListItem"> <span itemprop="name">省エネ対策</span>
          ...
          <picture class="mv_img">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/add_img/service/energy_saving/energy_saving_sp_mv.jpg" media="(max-width: 767px)">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/add_img/service/energy_saving/energy_saving_mv.jpg" alt="">
          </picture>
        </section>
      </div>
      <!-- mv -->
      <div class="cont_wrap">
        ...
        <div class="msg">
          理想の省エネ対策をプランニングいたします。間取りやスペースに応じるだけではなく、理想や夢をドンドン語ってください。スタッフはあなたと一緒に考えご提案いたします。理想きっと叶います。共にリフォームしてみませんか。
        </div>

        <section class="gas_appliances_wrap">
          <div class="sec_tit_box02">
            <h2 class="sec_tit02 Radley">ENERGY SAVING</h2>
            <p class="sec_sbtit02">省エネ対策のガス機器について</p>
          </div>
          <div class="inner">
            <div class="content_wrap flex_box_pc">
              <div class="content_item">
                ...
                <figure class="product_img type02">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/add_img/service/energy_saving/gas_image01.png" alt="">
                  <figcaption class="Radley sub_ttl">ENE FARM</figcaption>
                </figure>
                <dl class="txt_wrap">
                  <dt>エネファーム</dt>
                  <dd>天然ガスから水素を取り出し、空気中の酸素と化学反応させることで、エコな電気を生み出す家庭用燃料電池コージェネレーションシステム。</dd>
                </dl>
              </div>
              <div class="content_item">
                <figure class="product_img type02">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/add_img/service/energy_saving/gas_image02.png" alt="">
                  <figcaption class="Radley sub_ttl">Solar Power System</figcaption>
                </figure>
                <dl class="txt_wrap">
                  <dt>太陽光発電システム</dt>
                  <dd>太陽の光エネルギーを直接電気エネルギーに変換し、家庭で使える電力として利用するシステム。発電時にCO₂をまったく排出しないため、地球環境にも貢献。</dd>
                </dl>
              </div>
            </div>
            <div class="content_wrap flex_box_pc">
              <div class="content_item">
                ...
                <figure class="product_img type02">
                  <img src="<?php echo get_template_directory_uri(); ?>/assets/add_img/service/energy_saving/gas_image03.png" alt="">
                  <figcaption class="Radley sub_ttl">Storage Battery</figcaption>
                </figure>
                <dl class="txt_wrap">
                  <dt>蓄電池</dt>
